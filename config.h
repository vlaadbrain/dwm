...
static const char *browser[]    = { "surf-open.sh", "/home/ctorres/.surf/home.html", NULL };
...
static const char *vol_mute[]   = { "amixer", "-q", "set", ALSAMASTER, "toggle", NULL };
